    ...
    <div class="card card-body bg-light mt-5">
        ...
        <form action="<?= URLROOT?>/stories/edit/<?= $data['story-id'];?>" method="post">
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control form-control-lg <?=(!empty($data['title_err'])) ? 'is-invalid' : '';?>" value="<?= $data['story-title'] ?>">
            ...
            <div class="form-group">
                ...
                <select name="heading" class="form-control" id="" value="<?php foreach($data['story'] as $story) : echo $story->heading ; endforeach; ?>">
                    ...
                    <option value="histoire" <?=($data['story-heading'] == 'histoire') ? 'selected' : ''; ?>>histoire</option>
                    <option value ="sciences" <?=($data['story-heading'] == 'sciences') ? 'selected' : ''; ?>>sciences</option>
                    <option value ="politique" <?=($data['story-heading'] == 'politique') ? 'selected' : ''; ?>>politique</option>
                </select>
